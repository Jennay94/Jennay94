...
| :--- | :--- | :--- |
| **Smart IoT Sensor Network** | `ESP32`, `MQTT`, `C++` | 🏗️ In Progress |
| **LiveOps Data Pipeline** | `Python`, `SQL`, `AWS` | ✅ Completed |
| **AI Player Behavior Model** | `Machine Learning`, `Python` | 🧪 Researching |
